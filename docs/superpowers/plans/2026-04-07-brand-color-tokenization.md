...
Run:
```bash
grep -rl "pink-\|fuchsia-\|rose-500\|from-rose\|to-rose" /Users/chenhao/codes/myself/CareerPilot/src/components /Users/chenhao/codes/myself/CareerPilot/src/app --include="*.tsx" | grep -v "preview/templates/gradient" | grep -v "preview/templates/infographic"
```
...
Run:
```bash
grep -rn "pink-\|fuchsia-\|to-rose-500\|from-rose-500" /Users/chenhao/codes/myself/CareerPilot/src/components /Users/chenhao/codes/myself/CareerPilot/src/app --include="*.tsx" | grep -v "preview/templates/gradient" | grep -v "preview/templates/infographic"
```
...
Run:
```bash
grep -n "ec4899\|db2777\|f472b6\|pink" /Users/chenhao/codes/myself/CareerPilot/src/app/api/resume/[id]/export/templates/infographic.ts /Users/chenhao/codes/myself/CareerPilot/src/app/api/resume/[id]/export/templates/gradient.ts /Users/chenhao/codes/myself/CareerPilot/src/app/api/resume/[id]/export/docx.ts /Users/chenhao/codes/myself/CareerPilot/src/app/api/interview/[id]/report/export/html.ts
```
...
Run:
```bash
grep -n "ec4899\|db2777\|f472b6" /Users/chenhao/codes/myself/CareerPilot/src/app/api/resume/[id]/export/templates/infographic.ts /Users/chenhao/codes/myself/CareerPilot/src/app/api/resume/[id]/export/templates/gradient.ts /Users/chenhao/codes/myself/CareerPilot/src/app/api/resume/[id]/export/docx.ts /Users/chenhao/codes/myself/CareerPilot/src/app/api/interview/[id]/report/export/html.ts
```
...
Run: `grep -n "pink\|#ec4899\|#db2777\|#f472b6" /Users/chenhao/codes/myself/CareerPilot/src/components/preview/templates/gradient.tsx /Users/chenhao/codes/myself/CareerPilot/src/components/preview/templates/infographic.tsx`
...
<script
  dangerouslySetInnerHTML={{
    __html: `(function(){try{var b=localStorage.getItem('careerpilot-brand');if(b==='jade'){document.documentElement.setAttribute('data-brand','jade');}}catch(e){}})();`,
  }}
/>
```
...
```js
localStorage.setItem('careerpilot-brand','jade'); location.reload();
```
Expected: 刷新后整站为 emerald 绿色，无闪烁。再执行 `localStorage.removeItem('careerpilot-brand'); location.reload();` 恢复 BOSS 默认。
...
Run: `grep -rln "DropdownMenu\|UserMenu\|avatar" /Users/chenhao/codes/myself/CareerPilot/src/components/layout`
...
Run:
```bash
grep -rn "pink-\|fuchsia-\|#ec4899\|#db2777\|#f472b6" /Users/chenhao/codes/myself/CareerPilot/src
```
