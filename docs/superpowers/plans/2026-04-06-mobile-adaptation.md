...
**Goal:** Full-site responsive mobile adaptation for CareerPilot with zero desktop regressions. Below md (768px) is mobile.
...
In `share/[token]/page.tsx`, add similar bottom bar with "View on CareerPilot" action if not already accessible.
