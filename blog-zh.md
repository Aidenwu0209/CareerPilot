# 开源了一个 AI 简历生成器 CareerPilot：50 套模板、拖拽编辑、AI 对话优化、职业照生成、多格式导出，Docker 一键部署

大家好，分享一个我最近开源的项目 —— **CareerPilot**，一个 AI 驱动的智能简历生成器。
...
![模板画廊](https://ladr-1258957911.cos.ap-guangzhou.myqcloud.com/careerpilot/images/template-list.png)

### 简历编辑器

拖拽式编辑器，所见即所得。点击任意字段直接编辑，拖拽模块调整顺序，右侧实时预览效果。支持撤销/重做（50 步），自动保存不怕丢数据。

![简历编辑器](https://ladr-1258957911.cos.ap-guangzhou.myqcloud.com/careerpilot/images/resume-edit.png)
...
![AI 填充简历](https://ladr-1258957911.cos.ap-guangzhou.myqcloud.com/careerpilot/images/AI%20填充简历.gif)

### 2. 图片/PDF 简历解析

手里有一份旧简历的 PDF 或照片？直接上传，AI 自动识别并提取所有内容，填入编辑器。省去手动录入的时间。

![AI 图片简历解析](https://ladr-1258957911.cos.ap-guangzhou.myqcloud.com/careerpilot/images/图片简历解析.gif)
...
![AI 优化](https://ladr-1258957911.cos.ap-guangzhou.myqcloud.com/careerpilot/images/ai%20优化.png)

### 4. 语法与写作检查

一键检测简历中的弱动词、模糊描述、语法错误，给出质量评分和逐条修改建议。

![AI 语法检查](https://ladr-1258957911.cos.ap-guangzhou.myqcloud.com/careerpilot/images/AI%20语法检查.png)

发现问题后，可以**一键应用修复**，不用手动逐个改：

![语法一键修复](https://ladr-1258957911.cos.ap-guangzhou.myqcloud.com/careerpilot/images/AI%20语法检查一键修复.png)
...
![JD 匹配分析](https://ladr-1258957911.cos.ap-guangzhou.myqcloud.com/careerpilot/images/JD%20匹配分析.png)

### 6. AI 职业照生成

简历需要一张专业的证件照？不用去照相馆了。上传一张普通照片，AI 自动生成职业风格的证件照，可选择不同尺寸和背景样式，生成后直接下载使用。

![AI 职业照生成](https://ladr-1258957911.cos.ap-guangzhou.myqcloud.com/careerpilot/images/职业照生成.png)

### 7. 二维码名片模块

简历里可以添加二维码模块，自动为你的个人网站、GitHub、LinkedIn 等链接生成二维码。HR 扫码即可直达你的在线主页或作品集，让纸质简历也能链接到线上内容。

![二维码模块](https://ladr-1258957911.cos.ap-guangzhou.myqcloud.com/careerpilot/images/二维码.png)
...
![多格式导出](https://ladr-1258957911.cos.ap-guangzhou.myqcloud.com/careerpilot/images/多项导出.png)

### 10. 链接分享

生成一个分享链接，可以直接发给 HR 或朋友查看你的在线简历。支持密码保护和浏览次数统计。

![创建分享链接](https://ladr-1258957911.cos.ap-guangzhou.myqcloud.com/careerpilot/images/创建分享链接.png)

分享出去的简历页面长这样，干净专业：

![简历分享页](https://ladr-1258957911.cos.ap-guangzhou.myqcloud.com/careerpilot/images/简历分享页.png)
...
做个汇总，方便大家快速了解 CareerPilot 到底能做什么：
...
项目基于 Apache 2.0 协议。如果你正在找工作或者帮朋友改简历，可以试试本地 Docker 构建部署，AI 能力配上自己的 Key 就能用。
