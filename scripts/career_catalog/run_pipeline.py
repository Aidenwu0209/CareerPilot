...
from scripts.career_catalog.build_onet_major_graph import build
...
from scripts.career_catalog.crawl_onet_catalog import crawl as crawl_onet
...
def main() -> None:
    ...
    crawl_onet(delay=args.delay, output=RAW_DIR / "onet-crawl.json")
    build(
        parsed_path=RAW_DIR / "gcc-parsed.json",
        onet_crawl_path=RAW_DIR / "onet-crawl.json",
