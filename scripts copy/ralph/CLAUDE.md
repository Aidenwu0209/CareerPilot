...
项目根路径下读取 AGENTS.md，这是整个项目的技术架构开发指导说明，也就是 harness。

当前 story 的执行清单位于 `scripts/ralph/prd.json`。需要查看完整需求背景时，读取 `tasks/prd-careerpilot-commercialization-phase-1.md`。
